...
COUNTRY_NAMES = {'AF': 'Afghanistan', 'AL': 'Albania', 'DZ': 'Algeria', 'AS': 'American Samoa', 'AD': 'Andorra',
                 ...
                 'CK': 'Cook Islands', 'CR': 'Costa Rica', 'Code': 'Country name', 'HR': 'Croatia', 'CU': 'Cuba',
                 'CW': 'Curaçao', 'CY': 'Cyprus', 'CZ': 'Czech Republic', 'CI': "Côte d'Ivoire", 'DK': 'Denmark',
                 ...
                 'HN': 'Honduras', 'HK': 'Hong Kong', 'HU': 'Hungary', '(.uk)': 'ISO 3166-2:GB', 'IS': 'Iceland',
...
class CountryWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        painter.drawText(QRect(left_space, 0, icon_space, self.height() - bottom_pad), Qt.AlignLeft | Qt.AlignVCenter,
