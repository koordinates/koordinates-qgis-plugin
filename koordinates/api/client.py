...
class KoordinatesClient(QObject):
    ...
    def _build_datasets_request(
        self,
        page=1,
        query: Optional[DataBrowserQuery] = None,
        context=None,
        is_facets: bool = False,
    ...
    def _build_explore_sections_request(
        self, context=None
    ) -> Tuple[str, Dict[str, str], dict]:
        """
        Builds the parameters used for a datasets request
    ...
    def _build_explore_request(
        self, section_slug: str, context=None
    ) -> Tuple[str, Dict[str, str], dict]:
        """
        Builds the parameters used for a datasets request
        """
    ...
    def _build_publishers_request(
        ...
        params = {"public": "true", "sort": "popularity"}
    ...
    def datasets_async(
        self, page=1, query: Optional[DataBrowserQuery] = None, context=None
    ) -> QNetworkReply:
        """
    ...
    def facets_async(
        ...
        """
        endpoint, headers, params = self._build_datasets_request(
            page, query, context, is_facets=True
        )
        network_request = self._build_request(endpoint, headers, params)

        return QgsNetworkAccessManager.instance().get(network_request)

    def explore_sections_async(self, context=None) -> QNetworkReply:
        """
    ...
    def explore_async(self, section_slug: str, context=None) -> QNetworkReply:
        """
        Retrieve datasets asynchronously
        """
        endpoint, headers, params = self._build_explore_request(section_slug, context)
        network_request = self._build_request(endpoint, headers, params)

        return QgsNetworkAccessManager.instance().get(network_request)

    def publishers_async(
        self,
        publisher_type: Optional[PublisherType],
        page=1,
        filter_string: Optional[str] = None,
    ...
    def _get(self, endpoint, headers=None, params=None):
        ...
        return {"json": reply_json, "reply": request.reply()}
