...
class TestDataBrowser(unittest.TestCase):
    ...
    def test_data_type_to_string(self):
        self.assertEqual(DataType.to_filter_strings(DataType.Vectors), ["vector"])
        self.assertEqual(DataType.to_filter_strings(DataType.Rasters), ["raster"])
        self.assertEqual(
            DataType.to_filter_strings(DataType.Grids), ["grid", "attribute-grid"]
        )
        self.assertEqual(DataType.to_filter_strings(DataType.Tables), ["table"])
        self.assertEqual(
            DataType.to_filter_strings(DataType.PointClouds), ["pointcloud"]
        )
        self.assertEqual(DataType.to_filter_strings(DataType.Sets), ["set"])
        self.assertEqual(DataType.to_filter_strings(DataType.Repositories), ["repo"])
        self.assertEqual(DataType.to_filter_strings(DataType.Documents), ["document"])
    ...
    def test_data_from_string(self):
        ...
        self.assertEqual(DataType.from_string("attribute-grid"), DataType.Grids)
    ...
    def test_kind(self):
        ...
        self.assertEqual(
            query.build_query(), {"sort": "popularity", "kind": "pointcloud"}
        )
        ...
        self.assertEqual(
            query.build_query(), {"sort": "popularity", "kind": "document"}
        )
        # combined
        query.data_types = {DataType.Repositories, DataType.PointClouds}
        self.assertEqual(
            query.build_query(), {"sort": "popularity", "kind": ["pointcloud", "repo"]}
        )
    ...
    def test_vector_filters(self):
        ...
        self.assertEqual(
            query.build_query(), {"sort": "popularity", "data.geometry_type": "point"}
        )
        ...
        self.assertEqual(
            query.build_query(), {"sort": "popularity", "data.geometry_type": "polygon"}
        )
    ...
    def test_raster_filters(self):
        ...
        self.assertEqual(
            ...
            {
                "sort": "popularity",
                "raster_band": ["alpha", "blue", "green", "red"],
                "kind": "raster",
            },
        )
    ...
    def test_grid_filters(self):
        ...
        self.assertEqual(
            query.build_query(), {"sort": "popularity", "kind": "attribute-grid"}
        )
    ...
    def test_table_filter(self):
        ...
        self.assertEqual(
            query.build_query(), {"sort": "popularity", "kind": "table", "has_pk": True}
        )
    ...
    def test_date_filters(self):
        ...
        self.assertEqual(
            ...
            {
                "sort": "popularity",
                "created_at.after": "2022-01-03T00:00:00",
                "kind": ["layer", "table", "set", "document"],
            },
        )
        ...
        self.assertEqual(
            ...
            {
                "sort": "popularity",
                "created_at.before": "2022-01-03T00:00:00",
                "kind": ["layer", "table", "set", "document"],
            },
        )
        ...
        self.assertEqual(
            ...
            {
                "sort": "popularity",
                "updated_at.after": "2022-01-03T00:00:00",
                "kind": ["layer", "table", "set", "document"],
            },
        )
        ...
        self.assertEqual(
            ...
            {
                "sort": "popularity",
                "updated_at.after": "2020-01-03T00:00:00",
                "updated_at.before": "2022-01-03T00:00:00",
                "kind": ["layer", "table", "set", "document"],
            },
        )
    ...
    def test_license_filters(self):
        ...
        self.assertEqual(
            ...
            {
                "sort": "popularity",
                "license.type": ["-cc-by-nc", "-cc-by-sa"],
                "license.version": "3.0",
                "kind": ["layer", "table", "set", "document"],
            },
        )
    ...
    def test_sort(self):
        ...
        self.assertEqual(
            SortOrder.to_text(SortOrder.RecentlyUpdated), "Recently Updated"
        )
        self.assertEqual(
            SortOrder.to_text(SortOrder.AlphabeticalAZ), "Alphabetical (A-Z)"
        )
        self.assertEqual(
            SortOrder.to_text(SortOrder.AlphabeticalZA), "Alphabetical (Z-A)"
        )
    ...
    def test_capabilities(self):
        ...
        """
        self.assertEqual(
            DataType.capabilities(DataType.Vectors),
            {Capability.Clone, Capability.Add, Capability.RevisionCount},
        )
        self.assertEqual(
            DataType.capabilities(DataType.Rasters),
            {Capability.Clone, Capability.Add, Capability.RevisionCount},
        )
        self.assertEqual(
            DataType.capabilities(DataType.Grids),
            {Capability.Clone, Capability.Add, Capability.RevisionCount},
        )
        self.assertEqual(
            DataType.capabilities(DataType.Sets),
            {Capability.Clone, Capability.RevisionCount},
        )
        self.assertEqual(
            DataType.capabilities(DataType.Tables),
            {Capability.Clone, Capability.RevisionCount},
        )
        self.assertEqual(
            DataType.capabilities(DataType.Documents),
            {Capability.Clone, Capability.RevisionCount},
        )
        self.assertEqual(
            DataType.capabilities(DataType.Repositories),
            {Capability.Clone, Capability.RevisionCount},
        )
        self.assertEqual(
            DataType.capabilities(DataType.PointClouds),
