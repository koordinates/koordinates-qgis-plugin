...
class TestFilterWidgets(unittest.TestCase):
    ...
    def test_date_widget(self):
        ...
        w.set_facets(
            {
                "updated_at": {"min": "2022-01-01T00:00", "max": "2022-05-01T00:00"},
                "created_at": {"min": "2021-01-01T00:00", "max": "2021-05-01T00:00"},
            }
        )
    ...
    def test_publisher_widget(self):
        ...
        publisher1 = Publisher({"id": "site:1", "name": "Site 1"})
        publisher2 = Publisher({"id": "site:2", "name": "Site 2"})
    ...
    def test_data_type_widget(self):
        ...
        w.apply_constraints_to_query(query)
        self.assertEqual(
            query.data_types, {DataType.Rasters, DataType.Vectors, DataType.Grids}
        )
        self.assertEqual(query.vector_filters, set())
        self.assertEqual(query.raster_filters, set())
        self.assertEqual(query.raster_filter_options, set())
        ...
        w.apply_constraints_to_query(query)
        self.assertEqual(query.data_types, {DataType.Vectors})
        self.assertEqual(query.vector_filters, set())
        self.assertEqual(query.raster_filters, set())
        self.assertEqual(query.raster_filter_options, set())
        self.assertEqual(query.raster_band_filters, set())
        ...
        w.apply_constraints_to_query(query)
        self.assertEqual(query.data_types, {DataType.Vectors})
        self.assertEqual(query.vector_filters, {VectorFilter.Point})
        self.assertEqual(query.raster_filters, set())
        self.assertEqual(query.raster_filter_options, set())
        self.assertEqual(query.raster_band_filters, set())
        self.assertEqual(query.grid_filter_options, set())
    ...
    def test_resolution_widget(self):
        ...
        w.set_facets(
            {
                "raster_resolution": {"min": 10, "max": 20000},
            }
        )
        self.assertEqual(w.map_slider_value_to_resolution(w.slider.lowerValue()), 10)
        self.assertEqual(w.slider.upperValue(), 100000)
        self.assertEqual(w.map_slider_value_to_resolution(w.slider.upperValue()), 20000)

        w.slider.setLowerValue(w.map_value_to_slider(150))
        self.assertEqual(len(spy), 1)
        self.assertTrue(w.should_show_clear())
        ...
        w.slider.setUpperValue(w.map_value_to_slider(10500))
        self.assertEqual(len(spy), 2)
        self.assertTrue(w.should_show_clear())
        ...
        w.set_facets(
            {
                "raster_resolution": {"min": 5, "max": 50000},
            }
        )
        self.assertEqual(len(spy), 2)
        self.assertEqual(w.map_slider_value_to_resolution(w.slider.minimum()), 5)
        self.assertEqual(w.map_slider_value_to_resolution(w.slider.maximum()), 50000)
        ...
        w.slider.setUpperValue(w.map_value_to_slider(20000))
        self.assertEqual(len(spy), 5)
        # reapply same facet -- should not change setting, or raise signal
        w.set_facets(
            {
